...
public class PlayServicesHelper {
    ...
    public void registerGCMInBackground(final Context context) {
     ...
     */
    public boolean checkPlayServices(Activity currentActivity) {
        int resultCode = GooglePlayServicesUtil.isGooglePlayServicesAvailable(currentActivity);
